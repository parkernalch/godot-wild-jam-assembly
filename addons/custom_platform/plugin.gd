...
var rect_extents: CustomPlatform
# List of all anchors drawn over the CustomPlatform node
...
# Stores the CustomPlatform' state when the user starts dragging an anchor
...
func edit(object: Object) -> void:
	rect_extents = object
	print("editing " + str(rect_extents))
